            ...
            <div class="row m-l-0 m-r-0">
                ...
                <div class="col-sm-8">
                    <div class="card-block">
                        <h3 class="m-b-20 p-b-5 b-b-default f-w-600" id='info'>Information</h3>
                        <div class="row">
                            <div class="col-sm-6">
                    ...
                    <input id ="danger" type="submit" value="Delete my account" width="50px" className='createpostBtn' id='button' onClick={Deleteacc}/>
